...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 22 22:23:18 2023
...
def plot_growth_chart_months(child_data, reference_data):
...
app.layout = html.Div([
    ...
    html.Div([
        dcc.Graph(figure=plot_growth_chart_months(child_data, b_age_weight))
    ]),
